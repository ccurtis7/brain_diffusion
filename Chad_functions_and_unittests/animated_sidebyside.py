...
animated_sidebyside.py" and the trajectory should be plotted with points
advancing every 67 ms.  The rate of advancement can also be adjusted at the
user's discretion as annotated below.
"""
