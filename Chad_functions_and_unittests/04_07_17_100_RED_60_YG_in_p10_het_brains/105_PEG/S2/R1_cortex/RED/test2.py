...
name = '100nm_PEG_in_105_S2_cortex'
...
tau_m = 98
frame_m = 99 #atm I can't go lower than the actual value.

for num in range(1, totvids + 1):
    conversion[num] = (0.16, 4.98, 1)
    trajectory[num] = np.genfromtxt('./Traj_RED_{}.tif.csv'.format(num), delimiter =",")
