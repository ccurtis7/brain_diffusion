...
name = '60nm_YG_PEG_NPs_in_0_4p_agarose'
...
trajectory = dict()
trajectory[1] = np.genfromtxt('./YG_PEG_NPs_0_4p_agarose1.csv',
            delimiter =",")
trajectory[2] = np.genfromtxt('./YG_PEG_NPs_0_4p_agarose2.csv',
            delimiter =",")
trajectory[3] = np.genfromtxt('./YG_PEG_NPs_0_4p_agarose3.csv',
            delimiter =",")
trajectory[4] = np.genfromtxt('./YG_PEG_NPs_0_4p_agarose4.csv',
            delimiter =",")
trajectory[5] = np.genfromtxt('./YG_PEG_NPs_0_4p_agarose5.csv',
            delimiter =",")
...
exists = os.path.isfile('pM1x_{}.csv'.format(rank))

if exists == False:
    last_size = 1
    with open('pM1x_{}.csv'.format(rank), "wb") as f_handle:
        pass
    with open('pM1y_{}.csv'.format(rank), "wb") as f_handle:
        pass
    with open('pM2xy_{}.csv'.format(rank), "wb") as f_handle:
        pass
else:
