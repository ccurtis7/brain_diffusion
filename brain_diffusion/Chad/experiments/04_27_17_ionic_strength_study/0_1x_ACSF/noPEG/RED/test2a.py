...
name = 'RED_nPEG_in_agarose_0_1x_S1'
subset = 'a'
...
exists = os.path.isfile('pM1x{}_{}.csv'.format(subset, rank))

if exists == False:
    last_size = 1
    with open('pM1x{}_{}.csv'.format(subset, rank), "wb") as f_handle:
        pass
    with open('pM1y{}_{}.csv'.format(subset, rank), "wb") as f_handle:
        pass
    with open('pM2xy{}_{}.csv'.format(subset, rank), "wb") as f_handle:
        pass
else:
    with open('pM1x{}_{}.csv'.format(subset, rank), "rb") as f_handle:
