...
# -*- coding: utf-8 -*-
#
# brain_diffusion documentation build configuration file, created by
...
sphinx_gallery_conf = {
    ...
    'examples_dirs': '../../brain_diffusion/examples',
...
htmlhelp_basename = 'brain_diffusiondoc'
...
latex_documents = [
  (master_doc, 'brain_diffusion.tex', 'brain\\_diffusion Documentation',
   'Chad Curtis', 'manual'),
]
...
man_pages = [
    (master_doc, 'brain_diffusion', 'brain_diffusion Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'brain_diffusion', 'brain_diffusion Documentation',
   author, 'brain_diffusion', 'One line description of project.',
   'Miscellaneous'),
]
